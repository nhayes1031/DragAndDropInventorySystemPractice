...
public class UISelectionCursor : MonoBehaviour
{
    ...
    private void OnEnable() => _inventoryPanel.OnSelectionChanged += HandleOnPointerClick;

    private void OnDisable() => _inventoryPanel.OnSelectionChanged -= HandleOnPointerClick;
