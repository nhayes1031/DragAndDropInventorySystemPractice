...
namespace Tests
{
    public class base_state_machine
    {
        ...
        public void transition_does_not_switch_state_when_condition_is_not_met()
        {
            ...
            bool ShouldNotTransitionState() => false;
            stateMachine.AddTransition(firstState, secondState, ShouldNotTransitionState);
        ...
        [Test]
        public void transition_from_any_state_when_condition_is_met()
        {
            var stateMachine = new StateMachine();
        ...
        [Test]
        public void transition_does_not_switch_when_not_in_correct_source_state()
        {
            var stateMachine = new StateMachine();
